 ...
 * per planning/03-construction-co-ke/user-flows.md §1; the /admin console drives KYC approval and
 * dispute resolution. Mirrors laundry.co.ke's routes/web.php
...
$router->get('/admin', [$page, 'adminConsole']);
