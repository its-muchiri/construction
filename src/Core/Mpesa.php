...
/**
 * M-Pesa Daraja client (OAuth + STK Push), mirrored from laundry.co.ke's
 * reference implementation (see PaymentController's docblock — this is a
 * per-platform thin wrapper pending extraction to a shared package). Talks
 * to Safaricom's sandbox or production host depending on MPESA_ENV (see
 * .env.example).
 */
final class Mpesa
{
