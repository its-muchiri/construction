...
/**
 * E-commerce store — materials, hardware, and safety equipment (see
 * planning/03-construction-co-ke/prd.md's store scope; heavy equipment is
 * rental-only through ProjectController, not store-purchasable — see
 * that document's assumption note).
 */
